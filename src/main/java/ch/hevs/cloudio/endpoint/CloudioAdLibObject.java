...
public class CloudioAdLibObject extends CloudioObject {
     ...
     *
     */
    public CloudioAdLibObject() {
        internal = new InternalCustomObject();
    }
    ...
    public CloudioObject getObject(final String name) {
        return ((InternalCustomObject)internal).dynamicObjects.getItem(name).getExternalObject();
    }
    ...
    public void addObject(final String name, final CloudioObject object) throws DuplicateNamedItemException {
        ...
        ((InternalCustomObject)internal).dynamicObjects.addItem(object.internal);
    }
    ...
    public CloudioAttribute getAttribute(final String name) {
        return ((InternalCustomObject)internal).dynamicAttributes.getItem(name).getExternalAttribute();
    }
    ...
    public <T> CloudioAttribute<T> addAttribute(final String name, final Class<T> type, CloudioAttributeConstraint constraint)
        ...
        ((InternalCustomObject)internal).dynamicAttributes.addItem(attribute.internal);
    ...
    public static class Builder {
        private final CloudioAdLibObject object = new CloudioAdLibObject();
         ...
         * @return  Object.
         */
        public CloudioAdLibObject build() {
            return object;
        }
    }

    /*** Internal API *************************************************************************************************/
    class InternalCustomObject extends CloudioObject.InternalObject {
